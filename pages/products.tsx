...
import { startProductsRealtime, Product } from "../features/productsSlice";
import { startBrandRealtime, type BrandOrder } from "../features/brandSlice";
...
export default function ProductsPage() {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [products, search, selectedCategory, selectedBrands, sortBy]);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* Sidebar Filters */}
          <aside
            className={`${mobileFiltersOpen ? "block" : "hidden"} lg:block w-full lg:w-64 space-y-6`}
          >
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-1">
                  <Button onClick={()=>handleClear()}   className="  cursor-pointer">Clear Filter</Button>
                  {categories?.slice(0, 8)?.map((category: any) => (
                    <div key={category.name}>
                      <button
                        type="button"
                        onClick={() => setSelectedCategory(category.id)}
                        className={`flex items-center justify-between w-full  cursor-pointer   text-left py-1 hover:text-green-600 ${
                ...
                : (paginatedProducts.length > 0
                    ...
                    >
                      <div className="aspect-square relative bg-gray-100 flex items-center justify-center p-4">
                        ...
                        />
                        <Badge className="absolute top-1 text-white  rounded-md  left-1 bg-primary shadow-lg">
                          {product?.brand}
                        </Badge>
                      </div>
